...
export class LinkedInConnectStrategy extends PassportStrategy(Strategy, 'linkedin') {
  ...
  constructor(
    ...
    super({
      ...
      callbackURL: configService.get<string>('LINKEDIN_CALLBACK_URL') || `${configService.get<string>('API_URL') || 'https://backend-eazypost.mbokofit.com'}/api/social-accounts/callback/linkedin`,
