...
export const NeuInput = (props: any) => (
  <input 
    {...props} 
    className="bg-white dark:bg-zinc-800 border-2 border-black dark:border-white p-2 font-bold text-sm placeholder:text-gray-400 focus:outline-none focus:bg-zinc-50 dark:focus:bg-zinc-700 focus:shadow-[4px_4px_0px_0px_#000] dark:focus:shadow-[4px_4px_0px_0px_#fff] transition-all w-full font-mono text-black dark:text-white" 
  />
);
