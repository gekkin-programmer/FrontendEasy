...
const SpecularButton = ({
  ...
  // Keeps the long-running RAF loop below (which reads propsRef.current every
  // frame) in sync with the latest props, without needing to tear down and
  // restart that effect on every prop change. Runs post-render, not during it.
  useEffect(() => {
