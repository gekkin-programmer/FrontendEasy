    ...
    >
      ...
      <div className="relative w-full max-w-7xl bg-black border-4 border-black dark:border-white/5 shadow-[8px_8px_0px_0px_#000] md:shadow-[12px_12px_0px_0px_#000] p-6 md:p-16 overflow-hidden rounded-sm">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 md:space-y-8 mb-12 md:mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-white leading-[0.95] uppercase tracking-tighter">
            {t("Create Better.", "Créer Mieux.")}<br/>
            <span className="text-[#3C48F5] drop-shadow-[2px_2px_0px_rgba(0,0,0,0.15)]">Together.</span>
          </h2>

          <p className="text-lg md:text-xl font-bold text-white max-w-2xl mx-auto leading-snug px-2">
            {t(
        ...
        {/* === 2. MacBook Mockup === */}
        <div className="relative w-full max-w-4xl mx-auto mt-auto px-4 md:px-0">
          {/* MacBook Lid */}
