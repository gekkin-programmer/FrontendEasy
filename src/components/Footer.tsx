...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#040028] relative font-sans overflow-hidden flex flex-col h-auto md:h-[calc(100vh-87px)]">
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-[117px] pt-[40px] lg:pt-[60px] pb-[30px] lg:pb-[40px] h-full flex flex-col justify-between relative">
        ...
        <div className="flex flex-col gap-[20px] md:gap-[32px] relative z-10 w-full md:w-[587px]">
          <h2 className="font-bold text-[36px] md:text-[52px] leading-tight md:leading-[61px] text-white">
            {t('footer_title', 'Propulsez votre présence en ligne aujourd\'hui')}
          </h2>
        </div>
        ...
        {/* Columns Section */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-[30px] xl:gap-[32px] z-10 w-full mb-[20px]">
        ...
        {/* Divider */}
        <div className="w-full h-[1px] border-t border-[#FFFFFF] opacity-30 z-10 mb-[20px] md:mb-[30px]"></div>

        {/* Bottom Area: Socials, Lang & Buttons */}
        <div className="flex flex-col lg:flex-row justify-between items-center z-10 w-full gap-6 lg:gap-0">
