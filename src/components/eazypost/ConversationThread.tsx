...
const MOCK_CONVERSATION: Conversation = {
  ...
  messages: [
    ...
    },
    {
      ...
      content: "Adding to Alex's message - here's the link to our bulk upload guide: docs.eazypost.com/bulk-upload. Let us know if you have any questions!",
      timestamp: '55m ago',
      status: 'delivered',
      isInternal: false,
    },
    ...
    },
    {
      id: 7,
      sender: 'customer',
      content: "You guys are the best! Just tried it and it worked perfectly. Definitely recommending EazyPost to my network! 💙",
      timestamp: '30m ago',
    },
  ],
  status: 'open',
