    ...
    <section className="w-full bg-white relative py-[60px] md:py-[100px] flex flex-col items-center overflow-hidden">
      <div className="w-full max-w-[1435px] 3xl:max-w-[1900px] mx-auto flex flex-col relative px-[16px] md:px-[52px]">
        ...
        <div className="flex flex-row items-center justify-center md:justify-between flex-wrap gap-[24px] md:gap-y-[40px] w-full max-w-full min-h-[60px]">
          ...
          {/* Facebook */}
          <div className="w-[38px] h-[38px] md:w-[42px] md:h-[42px] 3xl:w-[50px] 3xl:h-[50px] flex-shrink-0 cursor-pointer hover:scale-110 transition-transform">
          ...
          {/* Twitter (X) */}
          <div className="w-[60px] h-[60px] 3xl:w-[76px] 3xl:h-[76px] flex-shrink-0 cursor-pointer hover:scale-110 transition-transform bg-[#242E36] rounded-full flex items-center justify-center p-2">
        ...
        {/* & plus */}
        <div className="flex justify-center w-full mt-[32px] md:mt-[40px]">
          <span className="font-['Rubik'] font-medium text-[20px] md:text-[24px] leading-[26px] md:leading-[30px] text-[#000000] cursor-pointer hover:text-[#174CD2] transition-colors">
            {t("& more", "& plus")}
          </span>
        </div>
      </div>
