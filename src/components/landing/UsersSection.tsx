...
export default function UsersSection() {
  ...
  return (
    <section className="w-full bg-white relative flex flex-col items-center pt-[40px] md:pt-[80px] pb-[80px] md:pb-[150px]">
      ...
      */}
      <div className="w-full relative h-full z-10">
        ...
        <div className="w-full max-w-[1435px] mx-auto px-[24px] md:px-[52px] pt-[20px] md:pt-[60px] relative z-10 flex flex-col">
          <span className="font-sans font-black text-[24px] md:text-[36px] leading-[30px] md:leading-[45px] text-[#000000]">
            EazyPost
          </span>
          <h2 className="font-sans font-black text-[36px] md:text-[70px] leading-[45px] md:leading-[87px] text-[#174CD2] mt-[-5px]">
            {t("for all types of profiles", "pour tout types de profils")}
          </h2>
        </div>

        {/* Main Container for Cards and Blue Bg */}
        <div className="w-full relative mt-[60px] md:mt-[150px] h-auto md:h-[861px]">
          ...
          <div className="w-full max-w-[1438px] mx-auto relative flex flex-col md:block h-auto md:h-full z-10 pb-12 md:pb-0">
