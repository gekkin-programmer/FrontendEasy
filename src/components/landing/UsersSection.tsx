...
const profileTypes = [
  {
    ...
    description: t("Eazlypost helps you publish regularly, analyze your performance and professionalize your image, without spending your life on social media.", "Eazlypost t'aide à publier régulièrement, à analyser tes performances et à professionnaliser ton image, sans passer ta vie sur les réseaux."),
    icon: (
  ...
  },
  {
    ...
    description: t("Eazlypost helps small and medium businesses manage their social media like big brands, with little time and few resources.", "Eazlypost permet aux petites et moyennes entreprises de gérer leurs réseaux comme de grandes marques, avec peu de temps et peu de ressources."),
    icon: (
  ...
  },
  {
    ...
    description: t("Eazlypost helps institutions, NGOs, associations and administrations speak with one voice on social media.", "Eazlypost aide les institutions, ONG, associations et administrations à parler d'une seule voix sur les réseaux sociaux."),
    icon: (
