...
// Facebook/Instagram/WhatsApp use `gradientUnits="userSpaceOnUse"` gradients,
// which resolve in the referencing element's local coordinate space. Each
// icon renders 3x simultaneously (once per HeroLines lane-set on this page),
// and the Navbar's Canaux dropdown reuses the same literal gradient ids when
// open — with a hardcoded id, browsers collapse all of those <linearGradient>
// defs into a single DOM id and can resolve `url(#id)` to the wrong instance's
// definition, which (for userSpaceOnUse) paints the gradient using a
// different element's coordinate space and can render as blank/missing.
// useId() keeps every mounted instance's gradient id unique so this can't happen.

export const FacebookIcon = () => {
  const gradId = `fb-grad-${useId()}`;
  return (
    <svg x="-26" y="-26" width="52" height="52" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id={gradId} x1="16" y1="2" x2="16" y2="29.917" gradientUnits="userSpaceOnUse">
...
export const InstagramIcon = () => {
  const uid = useId();
  const grad1 = `ig-grad1-${uid}`;
  const grad2 = `ig-grad2-${uid}`;
  const grad3 = `ig-grad3-${uid}`;
  return (
    <svg x="-26" y="-26" width="52" height="52" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${grad1})`}/>
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${grad2})`}/>
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${grad3})`}/>
      ...
      <defs>
        <radialGradient id={grad1} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(12 23) rotate(-55.3758) scale(25.5196)">
          <stop stopColor="#B13589"/>
          <stop offset="0.79309" stopColor="#C62F94"/>
          <stop offset="1" stopColor="#8A3AC8"/>
        </radialGradient>
        <radialGradient id={grad2} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(11 31) rotate(-65.1363) scale(22.5942)">
          <stop stopColor="#E0E8B7"/>
          <stop offset="0.444662" stopColor="#FB8A2E"/>
          <stop offset="0.71474" stopColor="#E2425C"/>
          <stop offset="1" stopColor="#E2425C" stopOpacity="0"/>
        </radialGradient>
        <radialGradient id={grad3} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(0.500002 3) rotate(-8.1301) scale(38.8909 8.31836)">
...
export const WhatsAppIcon = () => {
  ...
  return (
    <svg x="-26" y="-26" width="52" height="52" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M28 16C28 22.6274 22.6274 28 16 28C13.4722 28 11.1269 27.2184 9.19266 25.8837L5.09091 26.9091L6.16576 22.8784C4.80092 20.9307 4 18.5589 4 16C4 9.37258 9.37258 4 16 4C22.6274 4 28 9.37258 28 16Z" fill={`url(#${gradId})`}/>
