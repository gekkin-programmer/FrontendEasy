...
export default function CareerHeroLayout({ 
  ...
  return (
    <section className="w-full relative bg-transparent overflow-hidden flex justify-center items-start lg:min-h-[calc(100vh-172px)]">
      ...
      <div className="absolute bottom-0 right-0 lg:top-[210px] lg:bottom-auto z-0 opacity-40 md:opacity-100 lg:opacity-40 pointer-events-none">
      ...
      <div className="w-full max-w-[1440px] 3xl:max-w-[2200px] flex flex-col lg:flex-row items-center lg:items-center gap-[40px] lg:gap-[40px] xl:gap-[73px] 3xl:gap-[100px] px-4 md:px-[40px] lg:px-[40px] xl:px-0 3xl:px-[120px] pt-[40px] md:pt-[100px] lg:pt-[100px] xl:pt-[140px] 3xl:pt-[180px] z-10 relative lg:h-full">
            ...
            <div className="flex flex-col items-start w-full gap-[10px]">
              {titleNode ? titleNode : (
                <h1 className="flex flex-col font-['Rubik_One'] font-normal m-0 w-full gap-[2px] md:gap-[4px] lg:gap-[4px] xl:gap-[8px] 3xl:gap-[12px]">
                  <span className="text-[#000000] text-[20px] md:text-[28px] lg:text-[28px] xl:text-[36px] 3xl:text-[48px] leading-tight">
                    {t('EazyPost for', 'EazyPost pour les')}
                  </span>
                  <span className="text-[#174CD2] text-[32px] md:text-[56px] lg:text-[50px] xl:text-[70px] 3xl:text-[90px] leading-[1.1] capitalize">
                    {t('creators', 'créateurs')}
                  </span>
                  
                  <div className="flex flex-row items-baseline gap-[8px] md:gap-[16px] lg:gap-[12px] xl:gap-[16px] 3xl:gap-[24px]">
                    <span className="text-[#000000] text-[20px] md:text-[28px] lg:text-[28px] xl:text-[36px] 3xl:text-[48px] leading-tight">{t('of', 'de')}</span>
                    <span className="text-[#174CD2] text-[32px] md:text-[56px] lg:text-[50px] xl:text-[70px] 3xl:text-[90px] leading-[1.1] capitalize">{t('content', 'contenus')}</span>
                  </div>
                  
                  <div className="flex flex-row items-baseline gap-[8px] md:gap-[16px] lg:gap-[12px] xl:gap-[16px] 3xl:gap-[24px]">
                    <span className="text-[#000000] text-[20px] md:text-[28px] lg:text-[28px] xl:text-[36px] 3xl:text-[48px] leading-tight">{t('and', 'et')}</span>
                    <span className="text-[#174CD2] text-[32px] md:text-[56px] lg:text-[50px] xl:text-[70px] 3xl:text-[90px] leading-[1.1] capitalize">{t('Influencers', 'Influenceurs')}</span>
                  </div>
                </h1>
              )}
              <p className="text-[#000000] text-[14px] md:text-[20px] lg:text-[16px] xl:text-[20px] 3xl:text-[26px] font-normal leading-[22px] md:leading-[30px] lg:leading-[26px] xl:leading-[30px] 3xl:leading-[38px] font-['Rubik'] max-w-[650px] 3xl:max-w-[850px] m-0">
        ...
        <div className="relative w-full max-w-[650px] md:max-w-[100%] lg:max-w-[460px] xl:max-w-[800px] 3xl:max-w-[1050px] h-[320px] sm:h-[400px] md:h-[500px] lg:h-[500px] xl:h-[740px] 3xl:h-[960px] mt-[20px] lg:mt-0 flex-shrink-0 mx-auto">
          
          {/* Yellow Background Box - Frame 988 */}
          <div className="absolute w-full md:w-[90%] lg:w-[420px] xl:w-[700px] 3xl:w-[900px] h-[280px] sm:h-[340px] md:h-[440px] lg:h-[420px] xl:h-[640px] 3xl:h-[830px] right-0 md:left-[5%] lg:left-[20px] xl:left-[38px] 3xl:left-[50px] top-[40px] md:top-[40px] lg:top-[20px] xl:top-[80px] 3xl:top-[100px] bg-[#040028] rounded-[20px] rounded-br-[100px] z-0"></div>
          
          {/* Main Image */}
          <div className="absolute w-[90%] sm:w-[320px] md:w-[85%] lg:w-[380px] xl:w-[680px] 3xl:w-[880px] h-[260px] sm:h-[320px] md:h-[480px] lg:h-[440px] xl:h-[720px] 3xl:h-[930px] right-[5%] md:left-[10%] lg:left-[40px] xl:left-[58px] 3xl:left-[75px] top-0 bg-cover bg-center rounded-[20px] rounded-br-[100px] z-10" style={{ backgroundImage: `url('${heroImage}')` }}></div>
          
          {/* Blur Shadow Effect under Main Image */}
          <div className="absolute w-[120px] md:w-[173px] xl:w-[173px] 3xl:w-[225px] h-[80px] md:h-[141px] xl:h-[141px] 3xl:h-[183px] left-0 top-[160px] lg:top-[160px] xl:top-[300px] 3xl:top-[390px] bg-[#000000] opacity-5 blur-[64.5px] rounded-[14px] z-0"></div>
          
        </div>

        {/* Mobile CTA Button (below image - outside fixed-height container) */}
        <div className="flex lg:hidden items-center justify-center w-full mt-[-20px] sm:mt-[-30px] mb-2">
