...
const FolderTab = ({ children, isActive, onClick }: any) => (
  <button
    onClick={onClick}
    className={`
      relative px-3 md:px-6 py-2 md:py-3 font-black text-[10px] md:text-sm uppercase tracking-wider border-t border-l border-r border-gray-200 transition-all -mb-1 z-10 whitespace-nowrap flex-shrink-0
      ${isActive 
...
const CreatorCard = ({ imgSrc, name, followers, platform, platformIcon, iconBgClass }: CreatorData) => {
  return (
    <motion.div 
      ...
      className="bg-white border border-gray-100 p-3 md:p-4 flex flex-col items-center text-center shadow-md rounded-2xl relative group hover:shadow-xl transition-all duration-300"
    >
      <div className="relative mb-3 md:mb-4 w-20 h-20 md:w-24 md:h-24 mt-2">
        <div className="w-full h-full border-2 border-white shadow-sm rounded-xl overflow-hidden relative">
            <Image 
                src={imgSrc} 
                alt={name} 
                fill
        ...
        <div className={`absolute -bottom-2 -right-2 md:-bottom-3 md:-right-3 h-8 w-8 md:h-10 md:w-10 border-2 border-white flex items-center justify-center text-white shadow-md rounded-full ${iconBgClass}`}>
          {platformIcon}
        </div>
      </div>
...
const GrowSection = () => {
  ...
  return (
    <section 
      className="bg-white dark:bg-black border-b border-gray-100 dark:border-zinc-900 py-12 md:py-24 px-4 font-sans overflow-hidden relative"
      ...
      <div className="container mx-auto max-w-7xl relative z-10 px-0 md:px-4">
        ...
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-7 w-full overflow-hidden rounded-xl">
            ...
            <div className="flex items-end pl-2 md:pl-4 border-b border-gray-200 overflow-x-auto scrollbar-hide w-full pb-[2px]">
            ...
            {/* The Folder Content */}
            <div className="bg-[#3C48F5] border border-t-0 border-gray-200 p-4 md:p-8 min-h-[300px] md:min-h-[400px] shadow-lg rounded-b-2xl">
                <div className="flex justify-between items-center mb-4 md:mb-8 border-b border-white/20 pb-4">
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                        ...
                        <div className="w-2.5 h-2.5 md:w-4 md:h-4 bg-black rounded-full"></div>
                    </div>
                </div>
