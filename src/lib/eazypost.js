 ...
 * Generated: 2026-07-29T13:14:25.865Z
 */

/**
 * eazypost theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { eazypostTheme } from './eazypost';
 *   import './eazypost.css';
 */
export const eazypostTheme = {
  name: 'eazypost',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-rubik), sans-serif",
    "--font-family-heading": "var(--font-rubik), sans-serif",
    ...
    "--color-background-surface": "light-dark(#FFFFFF, #0A0A2E)",
    "--color-background-body": "light-dark(#F7F6F3, #040028)",
    "--color-background-card": "light-dark(#FFFFFF, #0A0A2E)",
    "--color-background-popover": "light-dark(#FFFFFF, #0A0A2E)",
    "--color-background-muted": "light-dark(#1C1B220D, #1C1B2280)",
    "--color-accent": "light-dark(#174CD2, #174CD2)",
    ...
    "--color-neutral": "light-dark(#1C1B221A, #E3E1EB33)",
    "--color-overlay": "light-dark(#1C1B2266, #1C1B2299)",
    "--color-overlay-hover": "light-dark(#1C1B220D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1C1B221A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#040028, #FFFFFF)",
    "--color-text-secondary": "light-dark(#8E8E8E, #8E8E8E)",
    "--color-text-disabled": "light-dark(#918F9D, #5E5D6A)",
    "--color-text-accent": "light-dark(#174CD2, #174CD2)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #00278F)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#174CD2, #174CD2)",
    "--color-icon-primary": "light-dark(#040028, #FFFFFF)",
    "--color-icon-secondary": "light-dark(#474552, #ABAAB8)",
    "--color-icon-disabled": "light-dark(#918F9D, #5E5D6A)",
    ...
    "--color-border": "light-dark(#D9D9D9, rgba(255, 255, 255, 0.1))",
    "--color-border-emphasized": "light-dark(#D9D9D9, rgba(255, 255, 255, 0.15))",
    "--color-skeleton": "light-dark(#ABAAB8, #474552)",
    ...
    "--color-border-blue": "light-dark(#174CD2, #174CD2)",
    ...
    "--color-background-inverted": "light-dark(#040028, #F7F6F3)",
    "--color-track": "light-dark(#ABAAB8, #474552)",
    "--radius-chat": "35px"
  },
