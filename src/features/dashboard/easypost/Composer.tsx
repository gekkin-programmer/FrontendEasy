      ...
      <div className="w-full bg-transparent md:bg-white md:dark:bg-[#0A0A2E] border-0 md:border md:border-[#D9D9D9] md:dark:border-white/10 md:pt-4 rounded-none relative overflow-hidden transition-all">
        ...
        <div className="pt-2 pb-1 md:px-6 md:pt-1 md:pb-2 transition-colors relative">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mt-0 md:mt-2 py-1 md:py-3 md:px-6 md:-mx-6 md:border-t md:border-black/5 md:dark:border-white/5 gap-1 md:gap-4 md:bg-[#F7F6F3] md:dark:bg-transparent transition-colors w-full max-w-full min-w-0 overflow-hidden">
            ...
            <div className="flex flex-nowrap items-center justify-center md:justify-start gap-1 sm:gap-2 py-1 md:pb-0 px-1 shrink-0 w-full max-w-full md:w-auto min-w-0 overflow-hidden">
              ...
              <div className="flex md:hidden flex-nowrap items-center justify-center gap-1">
                  <button onClick={() => onPreviewToggle ? onPreviewToggle() : setIsPreviewOpen(true)} className={cn("shrink-0 px-2 py-2 font-semibold text-[11px] rounded-[10px] transition-all flex items-center gap-1", isPreviewActive ? "bg-[#040028] dark:bg-white text-white dark:text-[#040028]" : "bg-white dark:bg-[#0A0A2E] text-[#040028] dark:text-white border border-black/10 dark:border-white/10 hover:bg-[#F7F6F3] dark:hover:bg-white/10")}>{t("Preview", "Aperçu")}</button>
                  <button onClick={() => handleSubmit('review')} disabled={isSubmitting} className="shrink-0 px-2 py-2 bg-white dark:bg-[#0A0A2E] text-[#040028] dark:text-white font-semibold text-[11px] rounded-[10px] border border-black/10 dark:border-white/10 hover:bg-[#F7F6F3] dark:hover:bg-white/10 transition-all flex items-center gap-1">{t("Review", "Révision")}</button>
                  <button onClick={() => handleSubmit(date ? 'queue' : 'execute')} disabled={isSubmitting || tiktokDisclosureInvalid} title={tiktokDisclosureInvalid ? 'You need to indicate if your content promotes yourself, a third party, or both' : undefined} className="shrink-0 px-2 py-2 bg-white dark:bg-[#0A0A2E] text-[#040028] dark:text-white font-semibold text-[11px] rounded-[10px] border border-black/10 dark:border-white/10 hover:bg-[#F7F6F3] dark:hover:bg-white/10 transition-all flex items-center gap-1 disabled:opacity-50 disabled:pointer-events-none">
