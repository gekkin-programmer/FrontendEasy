  ...
  if (isLoading) return (
    <div className="max-w-6xl mx-auto space-y-8 p-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="rounded-[16px] border border-black/5 dark:border-white/5 bg-white dark:bg-[#0A0A2E] shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] p-4 space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 rounded-[16px] border border-black/5 dark:border-white/5 bg-white dark:bg-[#0A0A2E] shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] p-4">
        ...
        <div className="rounded-[16px] border border-black/5 dark:border-white/5 bg-white dark:bg-[#0A0A2E] shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] p-4 space-y-4">
    ...
    <div className="max-w-6xl mx-auto space-y-8 font-sans text-[#040028] dark:text-white transition-colors">
        ...
        <div className="flex gap-3">
            ...
            {['7d', '30d', '90d'].map((range) => (
                ...
                className={`px-3 py-1.5 rounded-[8px] text-xs font-semibold transition-all ${
                    timeRange === range ? 'bg-white dark:bg-[#0A0A2E] text-[#174CD2] shadow-sm' : 'text-[#8E8E8E] hover:text-[#040028] dark:hover:text-white'
                }`}
                >
                {range.toUpperCase()}
                </button>
            ...
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-[10px] bg-[#174CD2] text-white font-semibold text-sm shadow-[0_4px_14px_rgba(23,76,210,0.3)] hover:bg-[#123a9e] transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.kpi.map((kpi: any, idx: number) => (
          <div key={idx} className="bg-white dark:bg-[#0A0A2E] border border-black/5 dark:border-white/5 rounded-[16px] p-5 shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#0A0A2E] border border-black/5 dark:border-white/5 rounded-[16px] p-6 shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] transition-colors">
        ...
        {/* Platform Breakdown */}
        <div className="bg-white dark:bg-[#0A0A2E] border border-black/5 dark:border-white/5 rounded-[16px] p-6 shadow-[0_2px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.3)] transition-colors">
