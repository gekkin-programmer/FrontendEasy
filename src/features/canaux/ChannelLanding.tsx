  ...
  return (
    <div className="bg-white font-sans">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-[48px] lg:gap-[16px]">
            <div className="flex-1 max-w-[664px]">
              ...
              <p className="mt-[24px] font-medium text-[20px] leading-[30px] tracking-[-0.4px] max-w-[562px] text-[#040028]">
                {t(
                  `Schedule your ${channelName} posts, manage your account and grow your community. Eazlypost brings your whole ${channelName} presence into one simple place.`,
                  `Programmez vos publications ${channelName}, gérez votre compte et développez votre communauté. Eazlypost réunit toute votre présence ${channelName} en un seul endroit.`
                )}
              </p>
      ...
      <SplitSection
        ...
        text={t(
          `Photos, videos, Reels, links, events… Prepare everything in advance, preview exactly how it will look on ${channelName}, and let Eazlypost publish at the perfect time.`,
          `Photos, vidéos, Reels, liens, événements… Préparez tout à l’avance, prévisualisez le rendu exact sur ${channelName} et laissez Eazlypost publier au moment parfait.`
        )}
        ctaLabel={startCta}
        ctaHref="/signup"
        ctaBg="#184CD1"
      ...
      <SplitSection
        ...
        text={t(
          `Publish consistently on ${channelName}, at the times your audience is actually online. Consistency is what turns visitors into followers — Eazlypost makes it automatic.`,
          `Publiez régulièrement sur ${channelName}, aux heures où votre audience est vraiment en ligne. C’est la régularité qui transforme les visiteurs en abonnés — Eazlypost la rend automatique.`
        )}
        ctaLabel={startCta}
        ctaHref="/signup"
        ctaBg="#FFFFFF"
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-[48px] pb-[64px] lg:pb-[96px] flex flex-col items-center gap-[64px]">
          ...
          <div className="max-w-[1065px] text-center">
            <blockquote className="font-extrabold text-[34px] leading-[40px] lg:text-[55px] lg:leading-[59px] tracking-[-1.12px]" style={{ color: INK }}>
              {t(
                `“Eazlypost changed how I run my ${channelName} page, everything lives in one place and it saves me hours every week.”`,
                `« Eazlypost a changé ma façon de gérer ma page ${channelName}, tout est au même endroit et je gagne des heures chaque semaine. »`
              )}
            </blockquote>
