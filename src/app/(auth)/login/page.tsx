        ...
        <div className="w-full max-w-[404px] xl:max-w-[480px] 2xl:max-w-[560px] 3xl:max-w-[640px] flex flex-col justify-center min-h-full my-auto py-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-[10px] sm:gap-[15px] mt-[10px] [@media(min-height:740px)]:mt-[16px] [@media(min-height:840px)]:mt-[20px] w-full">
              ...
              <button type="button" onClick={handleGoogleLogin} className="w-full sm:flex-1 h-[40px] [@media(min-height:740px)]:h-[44px] [@media(min-height:840px)]:h-[48px] lg:h-[48px] bg-white border border-[#000000] rounded-[10px] flex items-center justify-center gap-[10px] transition-colors hover:bg-gray-50">
                {/* Google */}
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
