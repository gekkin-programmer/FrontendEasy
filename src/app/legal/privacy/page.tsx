        ...
        <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Social Media Data:</strong> We access your connected social accounts (Facebook Pages, Instagram Business, LinkedIn, etc.) strictly to perform actions you authorize (scheduling posts, reading analytics).</li>
          ...
          <section className="border border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-950/30 rounded-xl p-6">
            ...
            <div className="space-y-5">
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">3a. Data Accessed</h3>
                <p>When you sign in with Google, we request the following OAuth 2.0 scopes:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
                  <li><strong>email</strong> — your primary Google account email address.</li>
                  <li><strong>profile</strong> — your display name (given and family name) and profile photo URL.</li>
                </ul>
                <p className="mt-2">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">3b. Data Usage</h3>
                ...
                <p className="mt-2">
                  We do <strong>not</strong> use Google user data to train AI or machine-learning models, serve advertisements, or transfer data to data brokers or advertisers.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">3c. Data Sharing</h3>
                <p>
                  We do not sell or share your Google user data with any third party except as strictly necessary to operate the service:
                </p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
                  <li>
                    <strong>Resend</strong> — receives your email address solely to deliver transactional emails you have requested (e.g., OTP codes, workspace invitations).
                  </li>
                  <li>
                    <strong>Neon (PostgreSQL)</strong> — your account data (name, email, profile photo URL, Google account ID) is stored in our cloud database to maintain your account.
                  </li>
                </ul>
                <p className="mt-2">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">3d. Data Storage &amp; Protection</h3>
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>Google OAuth access tokens are used transiently during sign-in and are <strong>not</strong> persisted to our database after your session is established.</li>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">3e. Data Retention &amp; Deletion</h3>
                <p>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-2">
                  <li>All personal data associated with your account is permanently deleted from our database within <strong>48 hours</strong>.</li>
                  <li>Backups containing your data are purged within <strong>30 days</strong>.</li>
                </ul>
                <p className="mt-2">
                  ...
                  with the subject line <strong>&ldquo;Data Deletion Request&rdquo;</strong> and your registered email address, or follow the steps at{' '}
                  <a href="/legal/data-deletion" className="text-blue-600 hover:underline">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong>OpenAI / DeepSeek / Groq:</strong> For AI content generation (content only — Google user data is never sent to these providers).</li>
              <li><strong>Neon:</strong> Serverless PostgreSQL hosting for all account and application data.</li>
            </ul>
          </section>
