...
export default function DashboardError({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-zinc-950 p-8 text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mt-4">{t('Dashboard error', 'Erreur du tableau de bord')}</h1>
      <p className="text-gray-500 dark:text-zinc-400 mt-2 max-w-sm">
        {t('Something failed while loading your dashboard.', 'Une erreur est survenue lors du chargement de votre tableau de bord.')}
      </p>
      <div className="flex gap-3 mt-6">
        ...
        >
          {t('Back to workspaces', 'Retour aux espaces de travail')}
        </button>
      </div>
    </div>
  );
