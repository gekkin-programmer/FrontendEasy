        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4 mt-2">
              <div className="border border-gray-700 rounded-xl p-5">
                <h3 className="font-semibold text-gray-100 mb-1">Essential Cookies</h3>
                <p className="text-sm">
              ...
              <div className="border border-gray-700 rounded-xl p-5">
                <h3 className="font-semibold text-gray-100 mb-1">Preference Cookies</h3>
                <p className="text-sm">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong className="text-gray-100">Sentry</strong> — sets a session identifier for error tracking and performance monitoring.</li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-3">
              <li>
                <strong className="text-gray-100">Chrome:</strong>{' '}
                Settings → Privacy and Security → Cookies and other site data
              </li>
              <li>
                <strong className="text-gray-100">Firefox:</strong>{' '}
                Settings → Privacy &amp; Security → Cookies and Site Data
              </li>
              <li>
                <strong className="text-gray-100">Safari:</strong>{' '}
