          ...
          <div className="mt-10">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
              ...
              <div>
                ...
                >
                  {isLoading ? <FaSpinner className="animate-spin h-5 w-5" /> : 'Get Started'}
                </button>
              </div>
            </form>
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              ...
              <Link href="/login" className="font-semibold leading-6 text-[#3C48F6] hover:text-blue-500">
                Log in
              </Link>
            </p>
          </div>
      ...
      <div className="relative hidden lg:flex flex-col h-full w-full bg-gray-50 dark:bg-gray-900">
        ...
        <div className="relative z-10 mt-auto p-12 text-white">
          <blockquote className="text-2xl font-medium leading-relaxed mb-6">
            "We scaled from 0 to 100k followers in 3 months using EasyPost's scheduling tools."
          </blockquote>
