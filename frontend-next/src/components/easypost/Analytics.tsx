                    ...
                    {totalInteractions === 0 ? (
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={chartData} layout="vertical" margin={{ left: 20, right: 20, top: 20, bottom: 20 }}>
                                ...
                                <Tooltip cursor={{fill: '#fef08a', opacity: 0.5}} contentStyle={{ backgroundColor: '#fff', borderRadius: '0px', border: '2px solid #000', boxShadow: '4px 4px 0px 0px #000', color: '#000', fontWeight: 'bold', textTransform: 'uppercase' }} />
