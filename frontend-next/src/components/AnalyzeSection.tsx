...
const InstagramPostCard = () => (
  <div className="bg-white rounded-xl shadow-lg border border-gray-200/80 w-full max-w-[360px] overflow-hidden">
    <div className="flex items-center gap-3 p-4">
      <div className="relative">
        {/* FIXED PATH: /assets/Automn.jpg */}
        <img src="/assets/Automn.jpg" alt="Profile" className="w-10 h-10 rounded-full object-cover"/>
    ...
    {/* FIXED PATH: /assets/Automn.jpg */}
    <img src="/assets/Automn.jpg" alt="Ceramic vases" className="w-full h-[320px] object-cover"/>
    ...
    <section className="bg-[#D6EFFF] mt-20 py-16 px-4 sm:px-6 md:py-20 lg:px-8 relative font-sans">
      <div className="container mx-auto grid lg:grid-cols-2 gap-y-16 lg:gap-x-8 items-center max-w-7xl">
        ...
        <div className="flex flex-col gap-6 text-gray-800 max-w-lg lg:max-w-none">
          <span className="font-semibold tracking-widest text-sm text-primary">{t("ANALYZE", "ANALYSER")}</span>
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
            {t("Whether it's basic analytics or in-depth reporting, Wiggle will help you learn what works and how to improve.", "Qu'il s'agisse d'analyses de base ou de rapports détaillés, Wiggle vous aidera à comprendre ce qui fonctionne et comment vous améliorer.")}
          </p>
          
          <a href="#" className="bg-primary text-white font-semibold py-3 px-6 rounded-3xl flex items-center justify-center gap-2 w-fit hover:bg-blue-700 transition-colors duration-300 transform hover:scale-105">
        ...
        {/* Right Column (Visuals) - Restored the widgets! */}
        <div className="relative min-h-[550px] flex flex-col items-center gap-6 lg:block">
            <div className="lg:absolute lg:top-0 lg:right-10 lg:z-20 transform hover:scale-105 transition-transform duration-500">
                <InstagramPostCard />
            </div>
            <div className="lg:absolute lg:top-40 lg:left-0 lg:z-30 transform hover:scale-105 transition-transform duration-500 animate-float-slow">
                <EngagementRateWidget />
            </div>
            <div className="lg:absolute lg:bottom-20 lg:right-0 lg:z-30 transform hover:scale-105 transition-transform duration-500 animate-float-medium">
                <FollowersWidget />
            </div>
        </div>
