...
export default function ProjectsPage() {
  return (
    <div className="space-y-10 p-4 md:p-8">
      <header>
        <h1 className="text-5xl font-black uppercase tracking-tighter text-black dark:text-white">Project_Nexus</h1>
        <p className="text-gray-500 dark:text-zinc-400 font-mono text-xs uppercase tracking-widest mt-2">Content_Campaign_Architecture</p>
      </header>
