...
export const metadata: Metadata = {
  title: 'Data Deletion | EasyPost Africa',
  description: 'How to delete your EasyPost data and revoke Facebook/Instagram access.',
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white dark:bg-gray-950 p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
          In compliance with the Meta Platform Terms and applicable privacy laws, this page explains how to remove EasyPost's access to your Facebook and Instagram data, and how to permanently delete your EasyPost account and all associated data.
        </p>
        ...
        <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800">
            ...
            <p className="mb-4 text-sm">
              This removes EasyPost's access to your Facebook and Instagram data. Your EasyPost account will remain active but social accounts will be disconnected.
            </p>
            <ol className="list-decimal pl-5 space-y-3 text-sm">
              ...
              <li>Find <strong>"EasyPost"</strong> in the list and click it.</li>
              <li>Click <strong>"Remove"</strong> and confirm.</li>
              <li>Facebook will notify EasyPost via our Data Deletion Callback URL, and we will delete all data obtained through those permissions within 48 hours.</li>
            </ol>
            <p className="mt-4 text-xs text-gray-400 dark:text-gray-500">
              Alternatively, within the EasyPost dashboard, go to <strong>Settings → Connected Accounts</strong> and click "Disconnect" next to any Facebook or Instagram account.
            </p>
          </section>
          ...
          <section className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800">
            ...
            <p className="mb-4 text-sm">
              This permanently deletes your EasyPost account, all your posts, media files, workspace data, and any data we obtained from connected platforms.
            </p>
            <ol className="list-decimal pl-5 space-y-3 text-sm">
              <li>
              ...
              <li>
                ...
                <a href="mailto:support@easypost.cm?subject=Data%20Deletion%20Request" className="text-blue-600 hover:underline font-semibold">
                  support@easypost.cm
                </a>{' '}
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm">
              <li>Your EasyPost account profile (name, email, avatar).</li>
              <li>All posts, drafts, and scheduled content.</li>
              <li>All media files you uploaded to EasyPost.</li>
          ...
          <section className="border-t border-gray-200 dark:border-gray-700 pt-8">
            <p className="text-sm">
              ...
              <a href="mailto:support@easypost.cm" className="text-blue-600 hover:underline">
                support@easypost.cm
              </a>.
            </p>
          </section>
